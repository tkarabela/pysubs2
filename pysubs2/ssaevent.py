import re
import warnings
from typing import Optional, Dict, Any, ClassVar, FrozenSet, Union, List
import dataclasses
...
class SSAEvent:
    ...
    vtt_cue_about: Dict[str, Union[str, List[Any], Dict[str, Any]]] = dataclasses.field(
        default_factory=dict)  #: vtt only
